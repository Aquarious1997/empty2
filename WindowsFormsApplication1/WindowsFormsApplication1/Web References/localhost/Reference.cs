...
namespace WindowsFormsApplication1.localhost {
    ...
    public partial class Service1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void registerAsync(string name, string password, string email, string secretQ, string secretA, string password2) {
            this.registerAsync(name, password, email, secretQ, secretA, password2, null);
        }
        
        /// <remarks/>
        public void registerAsync(string name, string password, string email, string secretQ, string secretA, string password2, object userState) {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://schemas.datacontract.org/2004/07/WcfService5")]
